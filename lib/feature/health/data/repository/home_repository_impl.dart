...
import 'package:project/feature/health/data/mapper/home_grid_detail_res_mapper.dart';
import 'package:project/feature/health/data/mapper/home_grid_res_mapper.dart';
import 'package:project/feature/health/data/mapper/home_slider_response_mapper.dart';
import 'package:project/feature/health/data/mapper/search_response_mapper.dart';
...
class HomeRepositoryImpl extends HomeRepository {
  ...
  Future<List<HomeGridModel>> getHomeGridData(int page, int size) async {
    final res =
        await _homeNetworkDataSource.getHomeGridItem(page: page, size: size);
  ...
  Future<List<SerachModelUI>> search({String? query, int? page}) async {
    final res = await _homeNetworkDataSource.getSearch(
      page: page,
  ...
  Future<List<CategoryModel>> getCategory() async {
    final res = await _homeNetworkDataSource.getCategoryResponse();
